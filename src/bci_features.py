"""Feature extraction helpers for CSE experiments on motor-imagery EEG."""
...
class WindowedFeatureResult:
    """Window-level feature matrix created from one or more EEG sessions."""
...
def extract_bandpower_windows(
    ...
    *,
    ...
    """Extract log band-power features from finite sliding EEG windows.

    Windows containing NaN or infinite separator samples are skipped. The
    output has observations as rows and channel-band combinations as columns.
    """
...
def concatenate_feature_results(
    ...
    """Concatenate session feature results into one ordered CSE stream."""
